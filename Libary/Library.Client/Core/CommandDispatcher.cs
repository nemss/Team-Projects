    ...
    public class CommandDispatcher
    {
        public string Dispatch(string input)
        {
            ...
            switch (commandName)
            {
                ...
                case "ModifyAuthor":
                    ModifyAuthorCommand modifyAuthor = new ModifyAuthorCommand();
                    result = modifyAuthor.Execute(inputArgs);
                    break;
                ...
                case "DeleteAuthor":
                    DeleteAuthorCommand deleteAuthor = new DeleteAuthorCommand();
                    result = deleteAuthor.Execute(inputArgs);
                    break;
